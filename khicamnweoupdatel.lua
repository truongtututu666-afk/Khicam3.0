...
-- Thông báo chào mừng
Notification.new("<Color=YellowChào mừng đến script khỉ cam,<Color=/>"):Display()
task.wait(1)
Notification.new("<Color=Yellow script chỉ beta.<Color=/>"):Display()
task.wait(1)
Notification.new("<Color=Yellow><quản trị viên>bạn sắpddc nhấp script<Color=/>"):Display()
task.wait(1)
Notification.new("<Color=Yellow><quản trị viên>script của khỉ cam.<Color=/>"):Display()
task.wait(1)
Notification.new("<Color=Yellow><<quản trị viên>..1...2...3...4...5..6..7..8910><Color=/>"):Display()
task.wait(1)
Notification.new("<Color=Yellow>bắt đầu<Color=/>"):Display()
task.wait(1)
Notification.new("<Color=Yellow>khỉ cam Roblox<Color=/>"):Display()
task.wait(5)
...
-- Tùy chỉnh
local TEXT = "Fast Attack By khỉ cam"
...
if _G.FastAttack then
    ...
    local Settings = {
        AutoClick = true,
        ClickDelay = 0.0000000000000000001
    }
...
ImageButton.Image = "rbxassetid://132815391220143"
	...
	coroutine.resume(
		coroutine.create(
			function()
				...
				Circle.ZIndex = 10
				Circle.Image = "rbxassetid://132815391220143"
...
UICorner.Parent = ImageButton
	...
	function tabs:Tab(Name, icon)
		...
		ImageLabel.Image = "http://www.roblox.com/asset/?id=132815391220143" .. icon
...
game:GetService("StarterGui"):SetCore(
    "SendNotification",
    {
        Title = "khỉ cam",
        Text = "Đã Tải Xong",
        Icon = "rbxassetid://132815391220143",
        Duration = 5
    }
)
